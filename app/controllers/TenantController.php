...
class TenantController extends AdminController {
    ...
    public function getIndex()
    {
        ...
        $this->heads = array(
            ...
            array('Unit',array('search'=>true,'sort'=>true)),
            array('From',array('search'=>true,'sort'=>true,'date'=>true)),
            array('To',array('search'=>true,'sort'=>true,'date'=>true)),
    ...
    public function postIndex()
    {
        ...
        $this->fields = array(
            ...
            array('contractFromDate',array('kind'=>'datetime','query'=>'like','pos'=>'both','show'=>true)),
            array('contractToDate',array('kind'=>'datetime','query'=>'like','pos'=>'both','show'=>true)),
            array('status',array('kind'=>'datetime','query'=>'like','pos'=>'both','show'=>true)),
